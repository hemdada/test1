...
package com.test1.rock.service;
...
public class Table1ServiceImpl implements Table1Service {
    ...
    @Transactional(value = "rockTransactionManager")
    @Override
	...
	@Transactional(readOnly = true, value = "rockTransactionManager")
	@Override
	...
	@Transactional(rollbackFor = EntityNotFoundException.class, value = "rockTransactionManager")
	@Override
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service rock for table Table1 to {} format", exportType);
